package com.example.vijay.contactpredictionframework.DataBaseProvider;
...
public class ContactFeatureProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.vijay.contactpredictionframework";
