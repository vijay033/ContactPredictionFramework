package com.example.vijay.contactpredictionframework.DataCollection;
...
import com.example.vijay.contactpredictionframework.DataBaseResolver.ContactFeatureProviderConstants;
...
public class convertDB2ARFF {
    ...
    private Cursor getContactFeatures(){
        Cursor cursor = null;
        if(contentResolver != null){
            cursor = contentResolver.query(ContactFeatureProviderConstants.CONTENT_URI_3, null,null,null,null,null);
        }else{
    ...
    public synchronized void readDataBase()  {
        ...
        Cursor cursor = getContactFeatures();
